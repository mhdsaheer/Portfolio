...
/**
 * Lucide dropped most brand marks, so WhatsApp is drawn here. `currentColor`
 * and a 24 viewBox keep it interchangeable with the lucide icons beside it.
 */
...
/**
 * Keyed by the `label` in `lib/contact.ts`. A social with no entry here still
 * renders - it falls back to its written name - so adding one to the data
 * never leaves a blank space where a link should be.
 */
